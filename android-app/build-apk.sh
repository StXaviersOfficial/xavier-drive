#!/bin/bash
# build-apk.sh — build Xavier's Drive v2.0.0 APK WITHOUT Gradle.
...
$BT/apksigner sign \
  ...
  --out "$PROJ/xavierdrive2.0.0.apk" \
  aligned.apk

$BT/apksigner verify --print-certs "$PROJ/xavierdrive2.0.0.apk" | head -4
ls -la "$PROJ/xavierdrive2.0.0.apk"
echo "APK BUILD DONE"
